...
function TryHackMeWidget() {
  ...
  // is regenerated by TryHackMe's server when someone visits the public share URL.
  // We:
  //   (1) fire a no-cors GET to the share URL so THM regenerates its S3 image,
  //   (2) wait a moment for that regen to complete,
  //   (3) bump a cache-busting query param so the browser refetches the fresh image.
